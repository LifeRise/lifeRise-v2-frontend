      ...
      <AnimatePresence>
        {open && (
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild aria-describedby="manager-modal-desc">
              <motion.div
                ...
                <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl border border-white/10 bg-slate-deep/95 backdrop-blur-xl shadow-2xl">
                  ...
                  <div className="relative p-6 space-y-6">
                    ...
                    <div className="p-4 rounded-xl border border-purple-accent/20 bg-purple-accent/5">
                      ...
                      <button className="flex items-center gap-1.5 text-xs font-bold text-purple-accent hover:text-lr-white transition-colors group">
