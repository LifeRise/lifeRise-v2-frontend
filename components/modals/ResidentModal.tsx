      ...
      <AnimatePresence>
        {open && (
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild aria-describedby="resident-modal-desc">
              <motion.div
              ...
              >
                <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl border border-white/10 bg-slate-deep/95 backdrop-blur-xl shadow-2xl">
                  ...
                  <div className="relative flex items-start justify-between p-6 pb-4 border-b border-white/6">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-teal text-xs font-bold uppercase tracking-[0.2em]">For Residents</span>
                      </div>
                  ...
                  <div className="relative p-6 space-y-6">
                    ...
                    <div className="space-y-3">
                      <p className="text-xs font-bold uppercase tracking-[0.15em] text-muted">Premium Features</p>
                      {features.map((f) => (
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-4 rounded-xl border border-teal/20 bg-teal/5">
                        <p className="text-xs text-muted leading-relaxed mb-3">
                          Unlock savings instantly at checkout. No complicated sign-up flow — just enter a code and your discount applies automatically.
                        </p>
                        {promos.map((p) => (
