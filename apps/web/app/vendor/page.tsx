...
import { Briefcase, TrendingUp, Star, DollarSign, CalendarDays, List } from 'lucide-react';
    ...
    <div className="px-4 sm:px-6 py-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <div
              className={`w-1.5 h-1.5 rounded-full ${isOnline ? 'bg-teal pulse-teal' : 'bg-muted'}`}
            />
          ...
          {todaySchedule.length > 0 ? (
            todaySchedule.map((s, i) => (
              ...
              >
                ...
                <div
                  className={`w-px h-6 rounded-full ${s.status === 'in-progress' ? 'bg-teal' : 'bg-white/8'}`}
                />
      ...
      <section>
        ...
        <GlassCard className="p-4 mt-3">
          ...
          <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/5">
            ...
            <p className="text-gold text-sm font-bold font-heading">{stats[1]?.value ?? '$0'}</p>
          </div>
        </GlassCard>
      </section>
    </div>
