...
const sectionNames: Record<string, { label: string; emoji: string; desc: string }> = {
  services: {
    label: 'Services',
    emoji: '🛍️',
    desc: 'Browse and book from our full catalog of resident services.',
  },
  bookings: {
    label: 'My Bookings',
    emoji: '📅',
    desc: 'View, reschedule, or cancel your upcoming appointments.',
  },
  events: {
    label: 'Events',
    emoji: '🎉',
    desc: 'Discover community events and activities in your complex.',
  },
  favorites: {
    label: 'Favorites',
    emoji: '❤️',
    desc: 'Your saved vendors and services for quick re-booking.',
  },
  notifications: {
    label: 'Notifications',
    emoji: '🔔',
    desc: 'Stay informed with alerts and updates from your complex.',
  },
  profile: {
    label: 'Profile',
    emoji: '👤',
    desc: 'Manage your account, preferences, and payment methods.',
  },
};
