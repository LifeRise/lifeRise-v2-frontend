...
import { DonutStat } from '@/components/admin/DonutStat';
...
const kpiConfig = [
  ...
  },
  {
    ...
    icon: Building2,
    color: '#64748B',
    href: '/admin/companies?type=complex',
  },
  {
    ...
    icon: Store,
    color: '#3B82F6',
    href: '/admin/companies?type=vendor',
  },
];
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 max-w-7xl mx-auto">
      ...
      >
        <div>
          <p className="text-muted text-sm mb-1 flex items-center gap-1.5">
            <LayoutDashboard size={12} style={{ color: ACCENT }} />
            {formatDate()}
          </p>
          <h1 className="font-heading font-extrabold text-lr-white text-3xl sm:text-4xl">
            Platform Overview
          </h1>
          <p className="text-muted text-sm mt-1">LifeRise · Admin Control Center</p>
        </div>
        <div className="hidden sm:flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 glass rounded-xl px-4 py-2.5">
            <div className="w-2 h-2 rounded-full bg-red-500 pulse-teal" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <GlassCard>
          <div className="p-4">
            <SectionHeader title="Platform Vendor Booking Stats" className="mb-4" />
        ...
        <GlassCard>
          <div className="p-4">
            <SectionHeader title="Platform Event Booking Stats" className="mb-4" />
            <div className="grid grid-cols-3 gap-4">
      ...
      {/* Lists Row: Popular Services + Most Booked Vendors */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <GlassCard>
          <div className="p-4">
              ...
              <div className="space-y-2">
                ...
                {data.most_booked_vendors.map((v) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-semibold text-right" style={{ color: ACCENT }}>
                      {v.booking_count}
                    </span>
                  </div>
                ))}
