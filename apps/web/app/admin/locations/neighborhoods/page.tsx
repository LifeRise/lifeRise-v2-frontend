...
export default function NeighborhoodsPage() {
  const [filters, setFilters] = useState({ search: '', type: 'neighborhood', page: 1 });
  ...
  return (
    <AdminPageShell
      title="Neighborhoods"
      subtitle={`${meta?.total ?? 0} neighborhoods`}
      action={
    ...
    >
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to delete this neighborhood? This action cannot be undone."
        confirmLabel="Delete"
