...
> = {
  '7d': [
    { label: 'Platform Users', value: '1,482', delta: '+12', up: true },
    { label: 'Bookings', value: '312', delta: '+8%', up: true },
    { label: 'Revenue', value: '$28K', delta: '+5%', up: true },
    { label: 'Support Tickets', value: '6', delta: '-3', up: false },
  ],
  '30d': [
    { label: 'Platform Users', value: '1,482', delta: '+48', up: true },
    { label: 'Bookings', value: '1,204', delta: '+18%', up: true },
    { label: 'Revenue', value: '$112K', delta: '+12%', up: true },
    { label: 'Support Tickets', value: '22', delta: '-8', up: false },
  ],
  '90d': [
    { label: 'Platform Users', value: '1,482', delta: '+231', up: true },
    { label: 'Bookings', value: '4,107', delta: '+31%', up: true },
    { label: 'Revenue', value: '$341K', delta: '+22%', up: true },
    { label: 'Support Tickets', value: '87', delta: '+14', up: true },
  ],
};
          ...
          {(['7d', '30d', '90d'] as Range[]).map((r) => (
            <button
              ...
              className={cn(
                ...
                range === r ? 'bg-[#EF4444] text-white' : 'text-muted hover:text-lr-white'
              )}
            >
