...
const sectionNames: Record<string, { label: string; emoji: string; desc: string }> = {
  analytics: {
    label: 'Analytics',
    emoji: '📊',
    desc: 'Deep-dive reports on occupancy, revenue, and service adoption.',
  },
  residents: {
    label: 'Residents',
    emoji: '🏘️',
    desc: 'Full resident directory with unit info and service history.',
  },
  vendors: {
    label: 'Vendors',
    emoji: '🤝',
    desc: 'Manage vendor contracts, approvals, and performance reviews.',
  },
  announcements: {
    label: 'Announcements',
    emoji: '📢',
    desc: 'Compose, schedule, and track complex-wide announcements.',
  },
  settings: {
    label: 'Settings',
    emoji: '⚙️',
    desc: 'Configure complex details, RBAC roles, and integrations.',
  },
};
    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-6 text-center">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mb-3">
          ...
          <span className="text-purple-accent text-xs font-bold uppercase tracking-widest">
            Coming Soon
          </span>
        </div>
