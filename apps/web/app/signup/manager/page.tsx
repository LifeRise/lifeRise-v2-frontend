...
export default function ManagerSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('[ManagerSignup] Registration failed:', err);
      const msg =
  ...
  return (
    <div className="relative min-h-screen gradient-mesh flex flex-col items-center justify-center px-4 py-12 overflow-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 -left-32 w-125 h-125 rounded-full opacity-20 blur-[100px] orb-purple" />
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-muted text-sm">Create your property management account</p>
        </div>
        ...
        <div className="glass rounded-2xl p-6 mb-6 space-y-4">
          ...
          {success && (
            <div className="bg-purple-accent/10 border border-purple-accent/20 rounded-xl px-4 py-3">
              <p className="text-purple-accent text-sm text-center">{success}</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-midnight/60 border border-white/10 rounded-xl pl-9 pr-3 py-3 text-sm text-lr-white placeholder-muted focus:outline-none focus:border-purple-accent/50 transition-colors"
                />
              </div>
              <div className="relative">
                <User size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted" />
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-midnight/60 border border-white/10 rounded-xl pl-9 pr-10 py-3 text-sm text-lr-white placeholder-muted focus:outline-none focus:border-purple-accent/50 transition-colors"
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 rounded-xl font-semibold text-sm text-midnight transition-all hover:opacity-90 active:scale-95 flex items-center justify-center gap-2 disabled:opacity-50"
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <p className="text-muted text-sm">
            ...
            <Link
              href="/login"
              className="text-purple-accent hover:opacity-80 transition-opacity font-medium"
            >
              Sign in
            </Link>
          </p>
