        ...
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-xl border border-teal/20 bg-teal/5">
            <p className="text-xs text-muted leading-relaxed mb-3">
              Promo codes drive acquisition and reward loyalty. Share codes with clients directly
              from your vendor dashboard to incentivize first bookings and referrals.
            </p>
            {promos.map((p) => (
