        ...
        <g key={zone.label}>
          ...
          {zone.dots.length > 0 &&
            zone.dots.map((dot, i) => {
              ...
              return (
                <g key={dot.label} className="cursor-pointer" onClick={() => onToggleDot(dotId)}>
                  {dot.active && (
    ...
    <>
      ...
      <div className="absolute bottom-3 right-3 flex items-center gap-3 text-[10px] text-muted">
        <span className="flex items-center gap-1">
          <span className="w-2 h-2 rounded-full bg-teal inline-block" /> Active
        </span>
        <span className="flex items-center gap-1">
          <span className="w-2 h-2 rounded-full bg-muted/40 inline-block" /> Offline
        </span>
      </div>
      ...
      <div className="absolute top-3 left-3 flex items-center gap-2">
        ...
        <span className="text-teal text-[10px] font-bold uppercase tracking-wider">
          Live Activity Map
        </span>
      </div>
