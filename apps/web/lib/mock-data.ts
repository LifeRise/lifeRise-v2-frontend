...
export const serviceDetails: ServiceDetail[] = vendors.map((v) => ({
  ...
  estimatedDuration:
    v.category === 'Meal Prep' ? 'Weekly' : v.category === 'Pets' ? '30 min' : '60 min',
...
export const bookingHistoryMap: Record<string, ResidentBooking> = {
    ...
    history: [
      {
        ...
        note: 'Booking confirmed by resident',
      },
      {
        status: 'Confirmed',
  ...
  rb3: {
    ...
    history: [
      ...
      {
        status: 'Completed',
        timestamp: 'May 18, 2026 10:30 AM',
        note: 'Service completed. Resident rated 5 stars.',
      },
    ],
    rating: 5,
  ...
  rb4: {
    ...
    history: [
      ...
      {
        status: 'Completed',
        timestamp: 'May 15, 2026 6:15 PM',
        note: 'Training session completed',
      },
    ],
    rating: 4,
  ...
  rb5: {
    ...
    history: [
      ...
      {
        status: 'Cancelled',
        timestamp: 'May 9, 2026 9:00 AM',
        note: 'Cancelled by resident. Refund processed.',
      },
    ],
    isRecurring: false,
  },
...
export const events: CommunityEvent[] = [
  {
    id: 'e1',
    title: 'Rooftop Yoga & Sunrise Meditation',
    date: 'May 23',
    time: '6:30 AM',
...
export const vendorServices: VendorServiceOffering[] = [
  {
    ...
    basePrice: 85,
    duration: '60 min',
    description: 'Intensive muscle therapy for chronic tension and pain relief.',
    isActive: true,
    bookingsCount: 47,
    viewsCount: 312,
  },
  {
    ...
    basePrice: 75,
    duration: '60 min',
    description: 'Relaxing full-body massage with gentle to medium pressure.',
    isActive: true,
    bookingsCount: 28,
    viewsCount: 198,
  },
...
export const vendorLeaderboard: LeaderboardEntry[] = [
  {
    ...
    initials: 'MC',
    gradient: 'from-emerald-700 to-teal-800',
    bio: 'Licensed massage therapist, 6+ years in deep tissue and prenatal care.',
    completionRate: 98,
  ...
  },
  {
    ...
    initials: 'CR',
    gradient: 'from-amber-700 to-orange-800',
    bio: 'Certified nutritionist and personal chef specialising in healthy weekly meal plans.',
    completionRate: 97,
    avgResponseTime: '< 1 hr',
    reviewCount: 89,
    topService: 'Weekly Meal Prep',
  },
  {
    rank: 3,
    name: 'Aria Johnson',
    ...
    initials: 'AJ',
    gradient: 'from-blue-700 to-indigo-800',
    bio: 'NASM-certified personal trainer focused on strength, mobility, and athletic performance.',
    completionRate: 96,
    avgResponseTime: '< 2 hr',
    reviewCount: 203,
    topService: 'Personal Training',
  },
  {
    rank: 4,
    name: 'David Kim',
    ...
    initials: 'DK',
    gradient: 'from-purple-700 to-violet-800',
    bio: 'Professional cleaner using eco-friendly products with meticulous attention to detail.',
    completionRate: 94,
    avgResponseTime: '< 1 hr',
    reviewCount: 156,
    topService: 'Home Deep Clean',
  },
  {
    rank: 5,
    name: 'Luna Park',
    ...
    initials: 'LP',
    gradient: 'from-pink-700 to-rose-800',
    bio: 'Certified dog trainer and licensed pet groomer with a lifelong passion for animals.',
    completionRate: 100,
    avgResponseTime: '< 30 min',
    reviewCount: 67,
    topService: 'Dog Walking & Care',
  },
  {
    rank: 6,
    name: 'James Wilson',
    ...
    initials: 'JW',
    gradient: 'from-cyan-700 to-sky-800',
    bio: 'RYT-500 yoga instructor and mindfulness coach offering group and private sessions.',
    completionRate: 95,
    avgResponseTime: '< 1 hr',
    reviewCount: 94,
    topService: 'Yoga & Meditation',
  },
];
...
export const residentDirectory: ResidentDirectoryEntry[] = [
  ...
  },
  {
    ...
    name: 'Emma Liu',
    unit: '7C',
    building: 'Riverside B',
    email: 'emma.l@riverside.com',
    phone: '(555) 345-6789',
    status: 'active',
  ...
  },
  {
    ...
    name: 'James Peterson',
    unit: '2F',
    building: 'Riverside C',
    email: 'james.p@riverside.com',
    phone: '(555) 678-9012',
    status: 'active',
    lastActivity: 'May 21, 2026',
    totalBookings: 6,
...
export const vendorApplications: VendorApplication[] = [
  {
    ...
    rating: 0,
    totalJobs: 0,
    bio: 'Certified aromatherapist and holistic wellness practitioner with 5 years of spa experience. Specialises in relaxation and stress-relief therapies.',
    yearsExperience: 5,
    phone: '(555) 901-2345',
  },
  {
    ...
    rating: 0,
    totalJobs: 0,
    bio: 'NASM-certified personal trainer and former collegiate track athlete. Specialises in strength conditioning, weight loss programmes, and sprint coaching.',
    yearsExperience: 3,
    phone: '(555) 012-3456',
  },
  {
    ...
    status: 'approved',
    documents: ['license.pdf', 'bg-check.pdf', 'insurance.pdf'],
    rating: 4.8,
    totalJobs: 14,
    bio: 'Professional home organiser and certified cleaner with commercial and residential experience. Background-checked and insured.',
    yearsExperience: 7,
    phone: '(555) 123-9999',
  },
];
...
export const announcements: Announcement[] = [
  {
    ...
    body: 'The pool will be closed May 24–25 for scheduled maintenance.',
    date: 'May 21',
  ...
  {
    id: 'a2',
    title: 'New Vendor: Healthy Bites Meal Prep',
    body: 'Carlos Rivera has joined LifeRise offering weekly meal prep packages.',
    date: 'May 20',
  ...
  {
    id: 'a3',
    title: 'Elevator B — Temporary Outage',
    body: 'Elevator B is undergoing urgent repairs. Estimated completion: May 22.',
    date: 'May 19',
    category: 'Urgent',
    urgent: true,
  },
...
export const notifications: NotificationItem[] = [
  {
    ...
    body: 'Your Deep Tissue Massage with Maya Chen on May 22 at 3:00 PM is confirmed.',
  ...
  },
  {
    ...
    body: 'Get 20% off all Home Care services this week only!',
  ...
  },
  {
    ...
    body: 'Your payment of $120 for Weekly Meal Prep has been processed.',
  ...
  },
  {
    id: 'n5',
    title: 'New Event',
    body: 'Community Fitness Challenge on May 28. 47 residents are interested!',
...
export const apiServices: Service[] = [
  {
    ...
    description: '60-minute targeted release for chronic tension. Includes hot-stone finish.',
    short_description: 'Targeted release for chronic tension.',
    price: '85.00',
    currency: 'USD',
    duration: 60,
  ...
  },
  {
    ...
    description: 'Classic full-body Swedish technique using aromatic oils.',
    short_description: 'Full-body relaxation with aromatic oils.',
    price: '75.00',
    currency: 'USD',
    duration: 60,
    category: { id: 1, name: 'Wellness', slug: 'wellness' },
  ...
  },
  {
    ...
    description: 'Deep-pressure work for athletes with mobility assessment.',
    short_description: 'Deep recovery for athletes.',
    price: '110.00',
    currency: 'USD',
    duration: 90,
    category: { id: 1, name: 'Wellness', slug: 'wellness' },
  ...
  },
  {
    ...
    description: 'Gentle, side-lying massage tailored for expectant mothers.',
    short_description: 'Gentle care for expectant mothers.',
    price: '95.00',
    currency: 'USD',
    duration: 60,
    category: { id: 1, name: 'Wellness', slug: 'wellness' },
  ...
  },
  {
    ...
    description: 'Guided assisted-stretch routine to improve range of motion.',
    short_description: 'Assisted stretching session.',
    price: '60.00',
    currency: 'USD',
    duration: 45,
    category: { id: 1, name: 'Wellness', slug: 'wellness' },
  ...
  },
  {
    ...
    description: 'Side-by-side massage for two in a candlelit setting.',
    short_description: 'Side-by-side for two.',
    price: '180.00',
    currency: 'USD',
    duration: 75,
    category: { id: 1, name: 'Wellness', slug: 'wellness' },
...
export const apiBookings: Booking[] = [
  ...
  {
    id: 1001,
    booking_number: 'LR-2026-1001',
    customer_id: 301,
    service_provider_id: 201,
    service_id: 101,
    status: 'Confirmed',
    booking_date: _offsetDate(0),
    start_time: '10:00:00',
    end_time: '11:00:00',
    duration: 60,
    price: '85.00',
    ...
    currency: 'USD',
    payment_status: 'paid',
    created_at: _offsetDate(-3),
    service_name: 'Deep Tissue Massage',
    customer_name: 'Sarah Mitchell',
    customer_avatar: 'SM',
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 4B, Riverside Tower',
  },
  {
    id: 1002,
    booking_number: 'LR-2026-1002',
    customer_id: 302,
    service_provider_id: 201,
    service_id: 105,
    status: 'Confirmed',
    ...
    currency: 'USD',
    payment_status: 'paid',
    created_at: _offsetDate(-2),
    service_name: 'Mobility & Stretch',
    customer_name: 'Daniel Cho',
    customer_avatar: 'DC',
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 12A, Riverside Tower',
  },
  {
    id: 1003,
    booking_number: 'LR-2026-1003',
    customer_id: 303,
    service_provider_id: 201,
    service_id: 102,
    status: 'Pending',
    ...
    final_price: '75.00',
    currency: 'USD',
    notes: 'Prefers lavender oil; mild pressure on shoulders.',
    payment_status: 'authorized',
    created_at: _offsetDate(0),
    service_name: 'Swedish Relaxation Massage',
    customer_name: 'Priya Sharma',
    customer_avatar: 'PS',
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 7C, Riverside Tower',
  },
  // Tomorrow
  {
    id: 1004,
    booking_number: 'LR-2026-1004',
    customer_id: 304,
    service_provider_id: 201,
    service_id: 103,
    status: 'Confirmed',
    booking_date: _offsetDate(1),
    start_time: '09:00:00',
    end_time: '10:30:00',
    duration: 90,
    price: '110.00',
    ...
    currency: 'USD',
    payment_status: 'paid',
    created_at: _offsetDate(-1),
    service_name: 'Sports Recovery Session',
    customer_name: 'Marcus Hill',
    customer_avatar: 'MH',
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 9D, Riverside Tower',
  },
  {
    id: 1005,
    booking_number: 'LR-2026-1005',
    customer_id: 305,
    service_provider_id: 201,
    service_id: 101,
    status: 'Pending',
    ...
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 3F, Riverside Tower',
  },
  // Next 3 days
  {
    id: 1006,
    booking_number: 'LR-2026-1006',
    customer_id: 306,
    service_provider_id: 201,
    service_id: 104,
    status: 'Confirmed',
    booking_date: _offsetDate(2),
    start_time: '11:00:00',
    end_time: '12:00:00',
    duration: 60,
    price: '95.00',
    ...
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 14B, Riverside Tower',
  },
  {
    id: 1007,
    booking_number: 'LR-2026-1007',
    customer_id: 307,
    service_provider_id: 201,
    service_id: 102,
    status: 'Confirmed',
    booking_date: _offsetDate(3),
    start_time: '14:00:00',
    end_time: '15:00:00',
    duration: 60,
    price: '75.00',
    ...
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 6A, Riverside Tower',
  },
  // Last 7 days — completed
  {
    id: 1008,
    booking_number: 'LR-2026-1008',
    customer_id: 308,
    service_provider_id: 201,
    service_id: 101,
    status: 'Completed',
    ...
    currency: 'USD',
    payment_status: 'paid',
    created_at: _offsetDate(-5),
    service_name: 'Deep Tissue Massage',
    customer_name: 'Aiko Tanaka',
    customer_avatar: 'AT',
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 11E, Riverside Tower',
  },
  {
    id: 1009,
    booking_number: 'LR-2026-1009',
    customer_id: 301,
    service_provider_id: 201,
    service_id: 103,
    status: 'Completed',
  ...
  },
  {
    ...
    currency: 'USD',
    payment_status: 'paid',
    created_at: _offsetDate(-8),
    service_name: 'Swedish Relaxation Massage',
    customer_name: 'Hassan Ali',
    customer_avatar: 'HA',
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 8C, Riverside Tower',
  },
  {
    id: 1011,
    booking_number: 'LR-2026-1011',
    customer_id: 310,
    service_provider_id: 201,
    service_id: 105,
    status: 'Completed',
    booking_date: _offsetDate(-5),
    start_time: '09:30:00',
    end_time: '10:15:00',
    duration: 45,
    price: '60.00',
    ...
    currency: 'USD',
    payment_status: 'paid',
    created_at: _offsetDate(-10),
    service_name: 'Mobility & Stretch',
    customer_name: 'Olivia Brennan',
    customer_avatar: 'OB',
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 2A, Riverside Tower',
  },
  {
    id: 1012,
    booking_number: 'LR-2026-1012',
    customer_id: 311,
    service_provider_id: 201,
    service_id: 104,
    status: 'Cancelled',
    booking_date: _offsetDate(-4),
    start_time: '13:00:00',
    end_time: '14:00:00',
    duration: 60,
    price: '95.00',
    ...
    created_at: _offsetDate(-9),
    service_name: 'Prenatal Massage',
    customer_name: 'Layla Hassan',
    customer_avatar: 'LH',
    provider_name: 'Marcus Johnson',
    provider_avatar: 'MJ',
    address: 'Unit 5D, Riverside Tower',
  },
];
...
export const apiResidentBookings: Booking[] = [
  ...
  {
    id: 2002,
    booking_number: 'LR-2026-2002',
    customer_id: 301,
    service_provider_id: 202,
    service_id: 0,
    status: 'Pending',
    booking_date: _offsetDate(2),
    start_time: '10:00:00',
    ...
    customer_name: 'Sarah Mitchell',
    customer_avatar: 'SM',
    provider_name: 'Carlos Rivera',
    provider_avatar: 'CR',
    address: 'Unit 4B, Riverside Tower',
  },
  {
    id: 2003,
    booking_number: 'LR-2026-2003',
    customer_id: 301,
    service_provider_id: 204,
    service_id: 0,
    status: 'Confirmed',
    booking_date: _offsetDate(4),
    start_time: '09:00:00',
  ...
  {
    id: 2004,
    booking_number: 'LR-2026-2004',
    customer_id: 301,
    service_provider_id: 203,
    service_id: 0,
    status: 'Completed',
    booking_date: _offsetDate(-3),
    start_time: '17:00:00',
    ...
    customer_name: 'Sarah Mitchell',
    customer_avatar: 'SM',
    provider_name: 'Aria Johnson',
    provider_avatar: 'AJ',
    address: 'Riverside Fitness Center',
  },
  {
    id: 2005,
    booking_number: 'LR-2026-2005',
    customer_id: 301,
    service_provider_id: 201,
    service_id: 102,
    status: 'Completed',
    booking_date: _offsetDate(-7),
    start_time: '14:00:00',
    end_time: '15:00:00',
    duration: 60,
    price: '75.00',
  ...
  {
    id: 2006,
    booking_number: 'LR-2026-2006',
    customer_id: 301,
    service_provider_id: 205,
    service_id: 0,
    status: 'Completed',
    booking_date: _offsetDate(-10),
    start_time: '08:00:00',
    end_time: '08:30:00',
    duration: 30,
    price: '25.00',
    ...
    currency: 'USD',
    payment_status: 'paid',
    created_at: _offsetDate(-15),
    service_name: 'Dog Walking & Care',
    customer_name: 'Sarah Mitchell',
    customer_avatar: 'SM',
    provider_name: 'Luna Park',
    provider_avatar: 'LP',
    address: 'Riverside Dog Park',
  },
  // Cancelled
  {
    id: 2007,
    booking_number: 'LR-2026-2007',
    customer_id: 301,
    service_provider_id: 201,
    service_id: 101,
    status: 'Cancelled',
    booking_date: _offsetDate(-14),
    start_time: '14:00:00',
    end_time: '15:00:00',
    duration: 60,
    price: '75.00',
